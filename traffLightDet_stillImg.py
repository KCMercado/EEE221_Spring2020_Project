...
#Read image
image = cv2.imread('greenlight03.png')
...
r_circles = cv2.HoughCircles(mask_redComb, cv2.HOUGH_GRADIENT, 1, 80, param1=50, param2=8, minRadius=5, maxRadius=50)
y_circles = cv2.HoughCircles(mask_yellow, cv2.HOUGH_GRADIENT, 1, 80, param1=50, param2=8, minRadius=3, maxRadius=30)
g_circles = cv2.HoughCircles(mask_green, cv2.HOUGH_GRADIENT, 1, 60, param1=50, param2=10, minRadius=3, maxRadius=30)
...
##        cv2.circle(image,(i[0],i[1]),2,(255,0,0),3)
        cv2.putText(image, 'Red', (i[0],i[1]), font, 1, (255,0,0), 2, cv2.LINE_AA)
...
##        cv2.circle(image,(i[0],i[1]),2,(255,0,0),3)
        cv2.putText(image, 'Yellow', (i[0],i[1]), font, 1, (255,0,0), 2, cv2.LINE_AA)
...
if g_circles is not None:
    ...
    for i in g_circles[0,:]:
        ...
        cv2.circle(image,(i[0],i[1]),i[2],(255,0,0),1)
##        cv2.circle(image,(i[0],i[1]),2,(255,0,0),3)
        cv2.putText(image, 'Green', (i[0],i[1]), font, 1, (255,0,0), 2, cv2.LINE_AA)
